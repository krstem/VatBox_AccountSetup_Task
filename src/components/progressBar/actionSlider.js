...
const sliderData = [
    {
        id: 1,
        title: `Call for Action #1`,
        content: `Exiting the method early if we are at the end of the images array.
                  We also want to reset currentIndex and translateValue, so we return to the first image in the array.`,
        footerText: `Lorem ipsum now`
    },
    {
        id: 2,
        title: `Call for Action #2`,
        content: `Exiting the method early if we are at the end of the images array.
                  We also want to reset currentIndex and translateValue, so we return to the first image in the array.`,
        footerText: `Lorem ipsum now`
    },
...
const ActionSlider = (props) => {
    ...
    return (
        <div className={CLASS_NAMES.SLIDER_CONTAINER}>
            {/* sliding div */}
            <div className={cx(CLASS_NAMES.SLIDING_ELEMENT, `${CLASS_NAMES.SLIDING_ELEMENT}-${sliderData}`)}>
